...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="mb-4 font-mono text-sm border border-border p-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="bg-black border-border text-white font-mono focus:border-white focus:ring-0 rounded-none"
                disabled={isLoading}
              />
            </div>
